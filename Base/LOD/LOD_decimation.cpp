/**
 * $Id: LOD_decimation.cpp 28254 2010-04-18 10:28:37Z campbellbarton $
...
LOD_LoadMesh(
	...
	const int * triangle_end = triangle_ptr + info->face_num*triangle_stride;
		...
		for (;triangle_ptr < triangle_end; triangle_ptr += triangle_stride) {
			...
			{
			  std::cerr << "impossibile aggiungere un triangolo :"<< triangle_ptr[0]<< " " <<triangle_ptr[1]<< " " << triangle_ptr[2] << std::endl;
			  return 0;
